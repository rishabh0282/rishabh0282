...
I'm a quality engineer building toward a full SDET profile — combining automation framework design,
codebase-level contribution, and a research background in computer vision and deep learning.
My work sits at the intersection of engineering quality and AI systems.
...
Selenium-based test automation with CI-integrated execution. Focused on issue investigation,
root-cause analysis, and dev-side bug resolution on a legacy AngularJS product.
Driving automation stability improvements across the test suite.

**Associate Systems Engineer** @ IBM India (Jun 2022 – Jul 2023)
Software testing and quality assurance for enterprise applications, with exposure to
Selenium/Java automation and CI-linked quality workflows.
...
> Engineered a modified YOLOv4 architecture for small-object detection in satellite imagery,
improving detection accuracy and inference efficiency.
...
> Proposed a novel anchor-free detection algorithm for waste object recognition,
outperforming anchor-based baselines in cluttered environments.
...
> Designed and optimized a CNN-based pipeline for automated waste classification.
...
> Developed a CNN-based UAV detection model for camouflaged and low-visibility scenarios.
...
**Quality Engineering**
`Selenium` `Playwright` `Java` `TypeScript` `REST API Testing` `GitHub Actions` `CI/CD` `BDD/Gherkin`
...
- Driving Selenium-based automation, API validation, and codebase-level contribution
on a legacy AngularJS product
- Open source contributor — merged PRs on a production Next.js/Node.js/SQLite application
- Exploring quality engineering for AI-powered systems, bridging research depth with
modern test engineering practices
